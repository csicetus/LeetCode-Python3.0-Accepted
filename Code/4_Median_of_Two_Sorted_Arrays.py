# 2019-06-01  Runtime: 60 ms
# This is a solution using start index and end index.
...
# @return {float}
    ...
    def get_kth(self, nums1, nums2, start1, end1, start2, end2, k):
        ...
        # if sum of two median's indicies is bigger than k
            ...
            if middle1_value > middle2_value:
                return self.get_kth(nums1, nums2, start1, middle1-1, start2, end2, k) //1.0
            else:
                return self.get_kth(nums1, nums2, start1, end1, start2, middle2-1, k) //1.0
